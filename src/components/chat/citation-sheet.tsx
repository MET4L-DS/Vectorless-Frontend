        ...
        <div className="p-6 flex flex-col h-full space-y-6">
          ...
          {selectedCitation ? (
            <motion.div 
              ...
              initial="hidden"
              animate="show"
              className="space-y-5 text-sm flex-1 overflow-y-auto pr-1"
            >
              ...
              <motion.div variants={itemVariants} className="pt-4 border-t border-zinc-200 dark:border-zinc-800 text-xs text-zinc-500 space-y-2">
